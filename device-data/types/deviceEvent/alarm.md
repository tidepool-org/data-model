...
for alarms signaling any other stoppage of insulin delivery not due to empty reservoir, dead battery, or occlusion

On some pumps (e.g. Medtronic) `no_delivery` may include all stoppages of delivery. That is, it may not always be possible to distinguish between empty reservoirs and occlusions.
